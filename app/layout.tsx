        ...
        <main className="flex flex-col items-center justify-center gap-24 p-24 max-w-6xl">
          <div className="flex flex-row relative items-center">
            ...
            <Image
              ...
              className="translate-x-20 -translate-y-4 hover:translate-x-30 hover:translate-y-6 hover:scale-110 ease-in-out duration-300 hover:rotate-45 absolute right-0 hidden md:block"
              width={75}
              height={75}
            />
          </div>
